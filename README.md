...
Double-cliquez sur `index.html`. Tout fonctionne, **sauf** le pont llama.cpp (le protocole `file://` bloque les requêtes réseau du navigateur).

### Option 2 — serveur local (recommandé)
Nécessaire uniquement pour utiliser llama.cpp. N'importe quel serveur statique convient :
